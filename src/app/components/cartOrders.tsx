...
function ButtonCart() {
    ...
    return (
        <>
            <div id="cart-icon" onClick={() => setIsClosed(!isClosed)} className="cart-icon cursor-pointer flex justify-center items-center fixed bottom-10 right-4 h-14 w-14 rounded-full bg-primary z-20">
                <ShoppingCart />
